...
const ThinkingChainSettingsModal: React.FC<Props> = ({ isOpen, onClose, value, onChange }) => {
    ...
    return (
        ...
        >
            <div
                className="sully-ui-sheet sully-ui-plain w-full sm:max-w-md bg-white rounded-t-3xl sm:rounded-3xl max-h-[85vh] overflow-y-auto overflow-x-hidden no-scrollbar shadow-2xl"
