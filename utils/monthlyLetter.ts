...
import { isMountedWorldbookEnabled, isScheduleOnlyWorldbook } from './worldbook';
...
export const buildMonthlyLetterRoleContext = (
    ...
    const worldbookLines = (character.mountedWorldbooks || [])
        .filter(book => isMountedWorldbookEnabled(book) && !isScheduleOnlyWorldbook(book) && !book.disable && book.mode !== 'offline')
